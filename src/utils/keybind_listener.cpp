...
void KeybindListener::ProcessKeyEvent(std::string key, bool pressed) {
    ...
    std::string activeKeys = Join(pressedKeys, '+');
...
std::vector<std::string> KeybindListener::Split(const std::string &str, char delimiter) {
...
std::string KeybindListener::Join(const std::vector<std::string> &tokens, char delimiter) {
